...
export default function Carousel() {
    ...
    return (
        <div
            ...
            <div
                className="text-dark relative z-10">
                {clickedSign === "unclicked" ?
                    ...
                    <>
                        <div className="flex items-center jusity-center flex-col">
                            <p className="text-3xl mb-4">{clickedSign}</p>
                        </div>
            ...
            <div className="absolute flex items-center justify-center"
                style={{
                    height: '37em',
                    width: '37em',
                    background: `${clickedSign === "unclicked" ? "radial-gradient(50% 50% at 50% 50%, #3B3170 8.28%, rgba(23, 18, 51, 0.54) 75%)" : "radial-gradient(50% 50% at 50% 50%, #CDCBC0 0%, #CDCBC0 55%, rgba(205, 203, 192, 0.06) 100%)"}`,
                    borderRadius: '100%'
                }}>
                {zodiac.map((sign, index) => (
                    <div
                        onClick={() => { setClickedSign(sign.name), setClickedSummary(sign.summary) }}
                        key={sign.id}
                        ...
                        style={{
                            ...
                            background: `${clickedSign === sign.name ? "radial-gradient(#17123310,#CDCBC0)" : "radial-gradient(var(--color--dark), #f5df60100)"}`,
                        }}
                    >
                        <Image
                            style={{
